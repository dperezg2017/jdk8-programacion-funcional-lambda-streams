...
import com.lab.Entity.CollectionUtil;
import com.lab.Entity.PersonaCollection;
import org.junit.Before;
import org.junit.Test;

public class TestUtilCollection {

	private List<PersonaCollection> lista;
	private CollectionUtil util;
	
	@Before
	public void init() {
		lista = new LinkedList<>();
		lista.add(new PersonaCollection("Juan de","Alicia",Optional.of("Martin")));
		lista.add(new PersonaCollection("Victoria","Mel",Optional.empty()));
