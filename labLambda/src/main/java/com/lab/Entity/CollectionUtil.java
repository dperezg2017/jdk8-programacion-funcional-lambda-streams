...
public class CollectionUtil {
	 ...
	 */
	public void eliminaNombresConEspacios(List<PersonaCollection> original) {
	 ...
	 */
	public void pasarAMayusculas (List<PersonaCollection> original) {
		original.replaceAll(p -> new PersonaCollection( p.getNombre().toUpperCase(),
